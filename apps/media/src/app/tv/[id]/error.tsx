...
/** Props for the TV series detail error boundary. */
...
/**
 * Route-level error boundary for the TV series detail page.
 *
 * Scoped to `tv/[id]` — will NOT catch errors in the root layout.
 * Renders an error message and a "Try again" button that calls `reset`
 * to re-render the failed segment.
 */
export default function TVErrorPage({
  error,
  reset,
