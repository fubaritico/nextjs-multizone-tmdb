 ...
 *
 * Branches the `useQuery` call based on `mediaType` to use the matching
 * option factory — the same one used by the server-side `prefetchQuery`,
 * guaranteeing a cache hit on first render.
 *
