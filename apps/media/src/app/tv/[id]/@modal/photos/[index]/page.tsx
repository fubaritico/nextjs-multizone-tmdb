...
/** Props for the TVPhotoModal intercepted route page. */
interface Props {
  /** Route params — `id` is the TV series ID, `index` is the zero-based photo index. */
 ...
 *
 * Active only during soft (client-side) navigation from the TV series detail page.
 ...
 */
export default function TVPhotoModal({ params }: Props) {
