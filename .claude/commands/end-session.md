...
1. Read `CLAUDE.md` (project root) to see the current Session State
...
3. Edit the `## Session State` section in `CLAUDE.md`:
...
4. Propose all changes to the user before writing — do not write without confirmation
